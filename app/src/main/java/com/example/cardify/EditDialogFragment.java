...
public class EditDialogFragment extends DialogFragment {
    ...
    // Объявления переменных для элементов интерфейса и данных
    ...
    //Интерфейс для обработки закрытия диалога.
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        // Получение LayoutInflater для создания View из XML
        inflater = requireActivity().getLayoutInflater();
        // Создание View из XML-файла фрагмента диалога
        View view = inflater.inflate(R.layout.fragment_edit_dialog, null);
        // Установка созданного View для AlertDialog
        builder.setView(view);

        // Инициализация элементов интерфейса из View
        ...
        // Получение ссылки на узел "users" в базе данных Firebase
        ...
        if (user != null) {
            ...
            userRef.child(userId).child("name")
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (name != null) {
                                // Установка имени пользователя в поле ввода
            ...
            // Установка текущего email пользователя в соответствующее поле ввода
            emailEditText.setText(user.getEmail());
        }

        // Установка слушателя кликов для кнопки сохранения
        saveButton.setOnClickListener(v -> saveChanges());
        // Создание и возврат AlertDialog
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            if (window != null) {
                ...
                requireActivity().getWindowManager().getDefaultDisplay().getMetrics(metrics); // Использование requireActivity()
